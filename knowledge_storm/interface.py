...
class Retriever:
    ...
    def retrieve(
        ...
        def process_query(q):
            # print("Nombre de threads actifs process_query:", threading.active_count())
...
class KnowledgeCurationModule(ABC):
    ...
    def apply_decorators(self):
        ...
        for method_name in methods_to_decorate:
            ...
            decorated_method = self.log_execution_time(original_method)
            setattr(self, method_name, decorated_method)

    @abstractmethod
    def research(self, **kwargs) -> InformationTable:
        """
